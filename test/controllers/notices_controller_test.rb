...
class NoticesControllerTest < ActionController::TestCase
  ...
  test "should create notice" do
    assert_difference('Notice.count') do
      post :create, notice: { send_user_id: @notice.send_user_id, target_id: @notice.target_id, type: @notice.type }
    end
  ...
  test "should update notice" do
    patch :update, id: @notice, notice: { send_user_id: @notice.send_user_id, target_id: @notice.target_id, type: @notice.type }
    assert_redirected_to notice_path(assigns(:notice))
  end
