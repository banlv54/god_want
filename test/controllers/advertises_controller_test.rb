...
class AdvertisesControllerTest < ActionController::TestCase
  ...
  test "should create advertise" do
    assert_difference('Advertise.count') do
      post :create, advertise: { comment: @advertise.comment, product_id: @advertise.product_id, user_id: @advertise.user_id, want_id: @advertise.want_id }
    end
  ...
  test "should update advertise" do
    patch :update, id: @advertise, advertise: { comment: @advertise.comment, product_id: @advertise.product_id, user_id: @advertise.user_id, want_id: @advertise.want_id }
    assert_redirected_to advertise_path(assigns(:advertise))
  end
